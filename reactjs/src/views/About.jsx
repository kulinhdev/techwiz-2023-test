    ...
    return (
        <>
            <section className="home-slider owl-carousel">
                ...
                <div className="slider-item" style={{backgroundImage: `url(asset/images/bg_3.jpg)`}} data-stellar-background-ratio="0.5">
            ...
            <section className="ftco-about d-md-flex">
                <div className="one-half img" style={{backgroundImage: `url(asset/images/about.jpg)`}}></div>
                <div className="one-half ">
                    <div className="overlap">
                        <div className="heading-section  ">
                            <span className="subheading">Discover</span>
                            <h2 className="mb-4" style={{zIndex:1}}>Our Story</h2>
                        </div>
                        <div>
            ...
            <section className="ftco-section img" id="ftco-testimony" style={{backgroundImage: `url(asset/images/bg_1.jpg)`}} data-stellar-background-ratio="0.5">
                <div className="overlay"></div>
                <div className="container">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="menu-entry">
                                        <a href="#" className="img" style={{backgroundImage: `url(asset/images/menu-1.jpg)`}}></a>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="menu-entry mt-lg-4">
                                        <a href="#" className="img" style={{backgroundImage: `url(asset/images/menu-2.jpg)`}}></a>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="menu-entry">
                                        <a href="#" className="img" style={{backgroundImage: `url(asset/images/menu-3.jpg)`}}></a>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="menu-entry mt-lg-4">
                                        <a href="#" className="img" style={{backgroundImage: `url(asset/images/menu-4.jpg)`}}></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="ftco-counter ftco-bg-dark img" id="section-counter" style={{backgroundImage: `url(asset/images/bg_2.jpg)`}} data-stellar-background-ratio="0.5">
                <div className="overlay"></div>
                <div className="container">
